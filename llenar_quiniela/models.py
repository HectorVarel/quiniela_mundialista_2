...
class Prediccion(models.Model):
    ...
    pJ1 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ2 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ3 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ4 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ5 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ6 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ7 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ8 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ9 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ10 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ11 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ12 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ13 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ14 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ15 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ16 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
    pJ17 = models.CharField(max_length=1000, default = 'X, X, X, X, X, X, X, X, X, X, X')
...
class Equipos_fotos(models.Model):
    ...
    mexico = models.TextField(max_length = 1000000, default = 'NC')
    sudafrica = models.TextField(max_length = 1000000, default = 'NC')
    m1 = models.TextField(max_length = 1000000, default = 'NC')
    corea = models.TextField(max_length = 1000000, default = 'NC')
    canada = models.TextField(max_length = 1000000, default = 'NC')
    m2 = models.TextField(max_length = 1000000, default = 'NC')
    qatar = models.TextField(max_length = 1000000, default = 'NC')
    suiza = models.TextField(max_length = 1000000, default = 'NC')
    brasil = models.TextField(max_length = 1000000, default = 'NC')
    marruecos = models.TextField(max_length = 1000000, default = 'NC')
    haiti = models.TextField(max_length = 1000000, default = 'NC')
    escocia = models.TextField(max_length = 1000000, default = 'NC')
    eua = models.TextField(max_length = 1000000, default = 'NC')
    paraguay = models.TextField(max_length = 1000000, default = 'NC')
    australia = models.TextField(max_length = 1000000, default = 'NC')
    m3 = models.TextField(max_length = 1000000, default = 'NC')
    alemania = models.TextField(max_length = 1000000, default = 'NC')
    curazao = models.TextField(max_length = 1000000, default = 'NC')
    costa_de_marfil = models.TextField(max_length = 1000000, default = 'NC')
    ecuador = models.TextField(max_length = 1000000, default = 'NC')
    holanda = models.TextField(max_length = 1000000, default = 'NC')
    japon = models.TextField(max_length = 1000000, default = 'NC')
    m4 = models.TextField(max_length = 1000000, default = 'NC')
    tunez = models.TextField(max_length = 1000000, default = 'NC')
    belgica = models.TextField(max_length = 1000000, default = 'NC')
    egipto = models.TextField(max_length = 1000000, default = 'NC')
    iran = models.TextField(max_length = 1000000, default = 'NC')
    nueva_zelanda = models.TextField(max_length = 1000000, default = 'NC')
    espania = models.TextField(max_length = 1000000, default = 'NC')
    cabo_verde = models.TextField(max_length = 1000000, default = 'NC')
    arabia_saudita = models.TextField(max_length = 1000000, default = 'NC')
    uruguay = models.TextField(max_length = 1000000, default = 'NC')
    francia = models.TextField(max_length = 1000000, default = 'NC')
    senegal = models.TextField(max_length = 1000000, default = 'NC')
    m5 = models.TextField(max_length = 1000000, default = 'NC')
    noruega = models.TextField(max_length = 1000000, default = 'NC')
    argentina = models.TextField(max_length = 1000000, default = 'NC')
    argelia = models.TextField(max_length = 1000000, default = 'NC')
    austria = models.TextField(max_length = 1000000, default = 'NC')
    jordania = models.TextField(max_length = 1000000, default = 'NC')
    portugal = models.TextField(max_length = 1000000, default = 'NC')
    m6 = models.TextField(max_length = 1000000, default = 'NC')
    uzbekistan = models.TextField(max_length = 1000000, default = 'NC')
    colombia = models.TextField(max_length = 1000000, default = 'NC')
    inglaterra = models.TextField(max_length = 1000000, default = 'NC')
...
class Clasificados(models.Model):
    clasificados = models.TextField(max_length = 1000000, default = 'NC')
