        ...
        if request.method == 'POST':
            ...
            if 'nombre_j' in request.POST:
                if 'partido1' in request.POST and  'partido2' in request.POST and 'partido3' in request.POST and 'partido4' in request.POST and 'partido5' in request.POST and 'partido6' in request.POST and 'partido7' in request.POST and 'partido8' in request.POST and 'partido9' in request.POST and 'partido10' in request.POST and 'partido11' in request.POST:
                    ...
                    partido12L = request.POST.get('partido12LMA')
                    partido12V = request.POST.get('partido12VMA')
                    partido12 = str(partido12L) + '-' + str(partido12V)
                    partido13L = request.POST.get('partido13LMA')
                    partido13V = request.POST.get('partido13VMA')
                    partido13 = str(partido13L) + '-' + str(partido13V)
                    partido14L = request.POST.get('partido14LMA')
                    partido14V = request.POST.get('partido14VMA')
                    partido14 = str(partido14L) + '-' + str(partido14V)
                    partido15L = request.POST.get('partido15LMA')
                    partido15V = request.POST.get('partido15VMA')
                    partido15 = str(partido15L) + '-' + str(partido15V)
                    partido16L = request.POST.get('partido16LMA')
                    partido16V = request.POST.get('partido16VMA')
                    partido16 = str(partido16L) + '-' + str(partido16V)
                    partido17L = request.POST.get('partido17LMA')
                    partido17V = request.POST.get('partido17VMA')
                    partido17 = str(partido17L) + '-' + str(partido17V)
                    partido18L = request.POST.get('partido18LMA')
                    partido18V = request.POST.get('partido18VMA')
                    partido18 = str(partido18L) + '-' + str(partido18V)
                    partido19L = request.POST.get('partido19LMA')
                    partido19V = request.POST.get('partido19VMA')
                    partido19 = str(partido19L) + '-' + str(partido19V)
                    partido20L = request.POST.get('partido20LMA')
                    partido20V = request.POST.get('partido20VMA')
                    partido20 = str(partido20L) + '-' + str(partido20V)
                    partido21L = request.POST.get('partido21LMA')
                    partido21V = request.POST.get('partido21VMA')
                    partido21 = str(partido21L) + '-' + str(partido21V)
                    partido22L = request.POST.get('partido22LMA')
                    partido22V = request.POST.get('partido22VMA')
                    partido22 = str(partido22L) + '-' + str(partido22V)
                    partido23L = request.POST.get('partido23LMA')
                    partido23V = request.POST.get('partido23VMA')
                    partido23 = str(partido23L) + '-' + str(partido23V)
                    partido24L = request.POST.get('partido24LMA')
                    partido24V = request.POST.get('partido24VMA')
                    partido24 = str(partido24L) + '-' + str(partido24V)
                    nombre_j = request.POST['nombre_j']
                    sec = partido1 + ', ' + partido2 + ', ' + partido3 + ', ' + partido4 + ', ' + partido5 + ', ' + partido6 + ', ' + partido7 + ', ' + partido8 + ', ' + partido9 + ', ' + partido10 + ', ' + partido11 + ', ' + partido12 + ', ' + partido13 + ', ' + partido14 + ', ' + partido15 + ', ' + partido16 + ', ' + partido17 + ', ' + partido18 + ', ' + partido19 + ', ' + partido20 + ', ' + partido21 + ', ' + partido22 + ', ' + partido23 + ', ' + partido24
                    if nombre_j == 'Luis':
                        nombre_j = 'Luis Angel'
                    elif nombre_j == 'Juan':
                        nombre_j = 'Juan Luis'
